    ...
    public class RoadMeshCreator : PathSceneTool
    {
        ...
        void CreateLeftWall()
        {
            ...
            for (int i = 0; i < path.NumPoints; i++)
            {
                ...
                // Find position to left and right of current path vertex
                Vector3 vertSideA = path.GetPoint(i) - localRight * Mathf.Abs(wallWidth + roadWidth) + localUp * thickness;
        ...
        void CreateRightWall()
        {
            ...
            for (int i = 0; i < path.NumPoints; i++)
            {
                ...
                // Find position to left and right of current path vertex
                Vector3 vertSideA = path.GetPoint(i) + localRight * Mathf.Abs(roadWidth) + localUp * thickness;
                Vector3 vertSideB = path.GetPoint(i) + localRight * Mathf.Abs(wallWidth + roadWidth) + localUp * thickness;
